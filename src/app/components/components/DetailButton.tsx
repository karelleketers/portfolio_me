...
export const DetailButton = ({ children, onClick, to, cs, bg}: DetailButtonProps) => {
	return (
		<button type="button" onClick={onClick} className={`${cs} group container w-complete lg:w-half xl:w-detw transition-all relative flex-wrap justify-center items-center h-screen overflow-hidden max-w-none max:w-proj`}>
