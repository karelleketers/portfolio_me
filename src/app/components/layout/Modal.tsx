                ...
                <div className="h-full flex-1 flex justify-center flex-wrap">
                    <div className="h-full flex flex-wrap items-center">
                        <ul className="text-center xl:text-left xl:flex-1 nav-list flex flex-col xl:flex-wrap xl:flex-row justify-center items-center">
                            <Link to="/" onClick={handleOnClick} className="w-4/5 my-4 mx-6 md:my-6 xl:my-8 overflow-hidden">
                            ...
                            <Link to="/projects" className="w-4/5 mx-6 my-4 md:my-6 xl:my-8 overflow-hidden">
                            ...
                            <Link to="/connect" className="w-4/5 mx-6 my-4 md:my-6 xl:my-8 overflow-hidden">
